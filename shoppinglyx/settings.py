...
import os 
EMAIL_HOST_USER = os.getenv('ss814547@gmail.com')
EMAIL_HOST_PASSWORD=os.getenv('zkur vakm mgyk kguc')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ss814547@gmail.com'
EMAIL_HOST_PASSWORD = 'zkur vakm mgyk kguc'